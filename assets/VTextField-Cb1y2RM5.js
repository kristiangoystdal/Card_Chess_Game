 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return E(this._path)?null:ps(this._path)}get ref(){return new Pe(this._repo,this._path)}get _queryIdentifier(){const e=Ur(this._queryParams),n=fs(e);return n==="{}"?"default":n}get _queryObject(){return Ur(this._queryParams)}isEqual(e){if(e=Ie(e),!(e instanceof zs))return!1;const n=this._repo===e._repo,i=vs(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Hf(this._path)}}class Pe extends zs{constructor(e,n){super(e,n,new ws,!1)}get parent(){const e=La(this._path);return e===null?null:new Pe(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Zt{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new D(e),i=en(this.ref,e);return new Zt(this._node.getChild(n),i,$)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Zt(s,en(this.ref,i),$)))}hasChild(e){const n=new D(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ap(t,e){return t=Ie(t),t._checkNotDeleted("ref"),e!==void 0?en(t._root,e):t._root}function en(t,e){return t=Ie(t),I(t._path)===null?A_("child","path",e):pl("child","path",e),new Pe(t._repo,V(t._path,e))}function xp(t){return t=Ie(t),new im(t._repo,t._path)}function Pp(t,e){t=Ie(t),Xe("push",t._path),Hn("push",e,t._path,!0);const n=Cl(t._repo),i=em(n),s=en(t,i),r=en(t,i);let o;return e!=null?o=Tl(r,e).then(()=>r):o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function Dp(t){return Xe("remove",t._path),Tl(t,null)}function Tl(t,e){t=Ie(t),Xe("set",t._path),Hn("set",e,t._path,!1);const n=new Ce;return $_(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Op(t,e){ml("update",e,t._path);const n=new Ce;return W_(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function Mp(t){t=Ie(t);const e=new Sl(()=>{}),n=new hi(e);return V_(t._repo,t,n).then(i=>new Zt(i,new Pe(t._repo,t._path),t._queryParams.getIndex()))}class hi{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new tm("value",this,new Zt(e.snapshotNode,new Pe(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new nm(this,e,n):null}matches(e){return e instanceof hi?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function sm(t,e,n,i,s){const r=new Sl(n,void 0),o=new hi(r);return G_(t._repo,t,o),()=>q_(t._repo,t,o)}function Lp(t,e,n,i){return sm(t,"value",e)}t_(Pe);o_(Pe);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
